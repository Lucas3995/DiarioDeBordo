...
Use template from `/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
