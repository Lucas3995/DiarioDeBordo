...
```bash
PHASE_INFO=$(node "/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
