...
- Usage: Reference from command with `@/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
