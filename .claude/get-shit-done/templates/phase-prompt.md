...
<!-- For checkpoint task examples and patterns, see @/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/references/checkpoints.md -->
...
See `/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
