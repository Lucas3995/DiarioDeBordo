...
See /media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/templates/discovery.md
...
Use /media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/get-shit-done/templates/discovery.md.
