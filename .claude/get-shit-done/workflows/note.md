...
- **Global scope**: `/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/notes/`)
...
2. Glob `/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/media/belo/BeloSSD_2/Workspace/DiarioDeBordo/.claude/notes/` — works in any directory
